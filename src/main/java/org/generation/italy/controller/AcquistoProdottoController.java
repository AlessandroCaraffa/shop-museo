...
public class AcquistoProdottoController {
	...
	@GetMapping("acquisti/delete/{id}/{acquistoProdottoId}")
	public String doDelete(Model model, @PathVariable("id") Integer id,@PathVariable("acquistoProdottoId") Integer acquistoProdottoId) {
		service.deleteById(acquistoProdottoId);
		return "redirect:/acquisti/{id}";
